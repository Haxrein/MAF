.class public Lcom/first/grid/LTpJfFn;
.super Lcom/first/grid/commons/CoreLTpJfFn;
.source "SourceFile"
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/first/grid/LTpJfFn$Builder;
    }
.end annotation
...
.method private constructor <init>()V
    ...
    invoke-direct {p0}, Lcom/first/grid/commons/CoreLTpJfFn;-><init>()V

    const/4 v0, 0x0

    iput-boolean v0, p0, Lcom/first/grid/LTpJfFn;->networkEventsEnabled:Z

    iput v0, p0, Lcom/first/grid/LTpJfFn;->networkUpdateMinutes:I

    iput-boolean v0, p0, Lcom/first/grid/LTpJfFn;->wifiFilterEnabled:Z

    iput-boolean v0, p0, Lcom/first/grid/LTpJfFn;->inAppEnabled:Z
    ...
    iput-object v0, p0, Lcom/first/grid/LTpJfFn;->inboxAuthMode:Ljava/lang/String;

    const-string v0, "https://inbox-api.indigitall.com/v1"

    iput-object v0, p0, Lcom/first/grid/LTpJfFn;->urlInboxApi:Ljava/lang/String;

    const/4 v0, 0x0

    iput-object v0, p0, Lcom/first/grid/LTpJfFn;->layoutBasic:Lcom/first/grid/commons/models/LayoutBasic;

    const-string v0, "android"

    invoke-virtual {p0, v0}, Lcom/first/grid/commons/CoreLTpJfFn;->setProductName(Ljava/lang/String;)V

    const-string v0, "5.1.3"

    invoke-virtual {p0, v0}, Lcom/first/grid/commons/CoreLTpJfFn;->setProductVersion(Ljava/lang/String;)V

    return-void
.end method

.method synthetic constructor <init>(Lcom/first/grid/LTpJfFn$1;)V
    .locals 0

    invoke-direct {p0}, Lcom/first/grid/LTpJfFn;-><init>()V
...
.method public constructor <init>(Lorg/json/JSONObject;)V
    ...
    invoke-direct/range {p0 .. p0}, Lcom/first/grid/commons/CoreLTpJfFn;-><init>()V

    move-object/from16 v19, v7

    const/4 v7, 0x0

    iput-boolean v7, v1, Lcom/first/grid/LTpJfFn;->networkEventsEnabled:Z

    iput v7, v1, Lcom/first/grid/LTpJfFn;->networkUpdateMinutes:I

    iput-boolean v7, v1, Lcom/first/grid/LTpJfFn;->wifiFilterEnabled:Z

    iput-boolean v7, v1, Lcom/first/grid/LTpJfFn;->inAppEnabled:Z
    ...
    iput-object v7, v1, Lcom/first/grid/LTpJfFn;->inboxAuthMode:Ljava/lang/String;

    const-string v7, "https://inbox-api.indigitall.com/v1"

    iput-object v7, v1, Lcom/first/grid/LTpJfFn;->urlInboxApi:Ljava/lang/String;

    const/4 v7, 0x0

    iput-object v7, v1, Lcom/first/grid/LTpJfFn;->layoutBasic:Lcom/first/grid/commons/models/LayoutBasic;

    const/4 v7, 0x1

    invoke-virtual {v1, v7}, Lcom/first/grid/commons/CoreLTpJfFn;->setEnabled(I)V
    ...
    invoke-virtual {v1, v3}, Lcom/first/grid/commons/CoreLTpJfFn;->setEnabled(I)V
    ...
    invoke-virtual {v1, v2}, Lcom/first/grid/commons/CoreLTpJfFn;->setLocationEnabled(Z)V
    ...
    invoke-virtual {v1, v2}, Lcom/first/grid/commons/CoreLTpJfFn;->setLocationAccuracy(I)V
    ...
    invoke-virtual {v1, v2}, Lcom/first/grid/commons/CoreLTpJfFn;->setLocationDistance(I)V
    ...
    invoke-virtual {v1, v2}, Lcom/first/grid/commons/CoreLTpJfFn;->setLocationUpdateMinutes(I)V
    ...
    invoke-virtual {v1, v2}, Lcom/first/grid/commons/CoreLTpJfFn;->setServiceSyncTime(I)V
    ...
    iput v2, v1, Lcom/first/grid/LTpJfFn;->networkUpdateMinutes:I
    ...
    iput-boolean v2, v1, Lcom/first/grid/LTpJfFn;->networkEventsEnabled:Z
    ...
    invoke-virtual {v1, v3}, Lcom/first/grid/commons/CoreLTpJfFn;->setMaintenanceStart(Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v2}, Lcom/first/grid/commons/CoreLTpJfFn;->setMaintenanceEnd(Ljava/lang/String;)V
    ...
    iput-boolean v2, v1, Lcom/first/grid/LTpJfFn;->inAppEnabled:Z
    ...
    iput-object v2, v1, Lcom/first/grid/LTpJfFn;->inboxAuthMode:Ljava/lang/String;
    ...
    :goto_0
    :try_start_1
    iput-object v2, v1, Lcom/first/grid/LTpJfFn;->secureSendingEnabled:Ljava/lang/String;
    ...
    iput-object v2, v1, Lcom/first/grid/LTpJfFn;->secureSendingAppPublicKey:Ljava/lang/String;
    ...
    iput-object v2, v1, Lcom/first/grid/LTpJfFn;->layoutBasic:Lcom/first/grid/commons/models/LayoutBasic;
    :try_end_1
...
.method static synthetic access$102(Lcom/first/grid/LTpJfFn;Ljava/lang/String;)Ljava/lang/String;
    .locals 0

    iput-object p1, p0, Lcom/first/grid/LTpJfFn;->senderId:Ljava/lang/String;

    return-object p1
.end method

.method static synthetic access$202(Lcom/first/grid/LTpJfFn;Z)Z
    .locals 0

    iput-boolean p1, p0, Lcom/first/grid/LTpJfFn;->wifiFilterEnabled:Z

    return p1
.end method

.method static synthetic access$302(Lcom/first/grid/LTpJfFn;Ljava/lang/String;)Ljava/lang/String;
    .locals 0

    iput-object p1, p0, Lcom/first/grid/LTpJfFn;->urlInboxApi:Ljava/lang/String;

    return-object p1
.end method

.method static synthetic access$402(Lcom/first/grid/LTpJfFn;Lcom/first/grid/commons/models/LayoutBasic;)Lcom/first/grid/commons/models/LayoutBasic;
    .locals 0

    iput-object p1, p0, Lcom/first/grid/LTpJfFn;->layoutBasic:Lcom/first/grid/commons/models/LayoutBasic;
...
.method public getInboxauthMode()Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/first/grid/LTpJfFn;->inboxAuthMode:Ljava/lang/String;
...
.method public getSecureSendingAppPublicKey()Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/first/grid/LTpJfFn;->secureSendingAppPublicKey:Ljava/lang/String;
...
.method public getSenderId()Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/first/grid/LTpJfFn;->senderId:Ljava/lang/String;
...
.method public isForce()Z
    ...
    iget-boolean v0, p0, Lcom/first/grid/LTpJfFn;->force:Z
...
.method public isInAppEnabled()Z
    ...
    iget-boolean v0, p0, Lcom/first/grid/LTpJfFn;->inAppEnabled:Z
...
.method public isLocationEnabled()Z
    ...
    invoke-virtual {p0}, Lcom/first/grid/commons/CoreLTpJfFn;->getLocationEnabled()Z
...
.method public isNetworkEventsEnabled()Z
    ...
    iget-boolean v0, p0, Lcom/first/grid/LTpJfFn;->networkEventsEnabled:Z
...
.method public isPlatformEnabled()Z
    ...
    invoke-virtual {p0}, Lcom/first/grid/commons/CoreLTpJfFn;->getEnabled()I
...
.method public updateLTpJfFn(Landroid/content/Context;)V
    .locals 6
    ...
    invoke-virtual {p0}, Lcom/first/grid/commons/CoreLTpJfFn;->getDefaultActivity()Ljava/lang/String;
    ...
    iget-boolean v1, p0, Lcom/first/grid/LTpJfFn;->force:Z
    ...
    :cond_3
    invoke-virtual {p0}, Lcom/first/grid/commons/CoreLTpJfFn;->getAppKey()Ljava/lang/String;
    ...
    :cond_4
    iget-object v1, p0, Lcom/first/grid/LTpJfFn;->senderId:Ljava/lang/String;
    ...
    :cond_6
    invoke-virtual {p0}, Lcom/first/grid/commons/CoreLTpJfFn;->getProductName()Ljava/lang/String;
    ...
    invoke-virtual {p0, v1}, Lcom/first/grid/commons/CoreLTpJfFn;->setProductName(Ljava/lang/String;)V
    ...
    :cond_b
    invoke-virtual {p0}, Lcom/first/grid/commons/CoreLTpJfFn;->getProductVersion()Ljava/lang/String;
    ...
    :cond_d
    invoke-virtual {p0}, Lcom/first/grid/commons/CoreLTpJfFn;->getServiceSyncTime()I
    ...
    :cond_f
    invoke-virtual {p0}, Lcom/first/grid/commons/CoreLTpJfFn;->getMaintenanceStart()Ljava/lang/String;
    ...
    :cond_11
    invoke-virtual {p0}, Lcom/first/grid/commons/CoreLTpJfFn;->getMaintenanceEnd()Ljava/lang/String;
    ...
    iget v4, p0, Lcom/first/grid/LTpJfFn;->networkUpdateMinutes:I
    ...
    iget-object v1, p0, Lcom/first/grid/LTpJfFn;->inboxAuthMode:Ljava/lang/String;
    ...
    :cond_13
    iget-boolean v1, p0, Lcom/first/grid/LTpJfFn;->wifiFilterEnabled:Z
    ...
    iget-boolean v4, p0, Lcom/first/grid/LTpJfFn;->networkEventsEnabled:Z
    ...
    iget-boolean v2, p0, Lcom/first/grid/LTpJfFn;->wifiFilterEnabled:Z
    ...
    invoke-virtual {p0}, Lcom/first/grid/commons/CoreLTpJfFn;->getLogLevel()Lcom/first/grid/commons/models/LogLevel;
    ...
    invoke-virtual {p0}, Lcom/first/grid/commons/CoreLTpJfFn;->getUrlDeviceApi()Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/first/grid/LTpJfFn;->urlInboxApi:Ljava/lang/String;
    ...
    :cond_16
    iget-object v1, p0, Lcom/first/grid/LTpJfFn;->layoutBasic:Lcom/first/grid/commons/models/LayoutBasic;
    ...
    :cond_17
    iget-object v1, p0, Lcom/first/grid/LTpJfFn;->secureSendingEnabled:Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/first/grid/LTpJfFn;->secureSendingAppPublicKey:Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/first/grid/LTpJfFn;->secureSendingAppPublicKey:Ljava/lang/String;
...
.method public updateLTpJfFn(Landroid/content/Context;Z)V
    .locals 0

    iput-boolean p2, p0, Lcom/first/grid/LTpJfFn;->force:Z

    invoke-virtual {p0, p1}, Lcom/first/grid/LTpJfFn;->updateLTpJfFn(Landroid/content/Context;)V
